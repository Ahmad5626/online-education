!(this, function () {
  ...
  const N = {
      ...
      if ("string" == typeof t && e) {
        ...
        if (void 0 === o) {
          ...
          for (const [i, n] of Object.entries(c)) {
            const s = i.replace(w, "");
            (a && !t.includes(s)) ||
              D(e, l, r, n.callable, n.delegationSelector);
          }
    ...
    trigger(e, t, i) {
      ...
      const l = P(new Event(t, { bubbles: o, cancelable: !0 }), i);
      return (
        a && l.preventDefault(),
        r && e.dispatchEvent(l),
    ...
    z = (t, i = "hide") => {
      ...
      N.on(document, e, `[data-bs-dismiss="${n}"]`, function (e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
          h(this) ||
            ((e = B.getElementFromSelector(this) || this.closest(`.${n}`)),
  ...
  class R extends H {
    ...
    close() {
      var e;
      N.trigger(this._element, "close.bs.alert").defaultPrevented ||
  ...
  class Y extends F {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (N.on(this._element, "pointerdown.bs.swipe", (e) => this._start(e)),
          N.on(this._element, "pointerup.bs.swipe", (e) => this._end(e)),
          this._element.classList.add("pointer-event"))
        : (N.on(this._element, "touchstart.bs.swipe", (e) => this._start(e)),
  ...
  const U = ".bs.carousel",
    ...
    se = ".active",
    oe = ".carousel-item",
    re = (se, oe, { ArrowLeft: ee, ArrowRight: Z }),
    ae = {
      interval: 5e3,
      keyboard: !0,
      pause: "hover",
  ...
  class ce extends H {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? N.one(this._element, te, () => this.cycle())
          : this.cycle());
    }
    to(e) {
      var t,
      ...
      e > i.length - 1 ||
        e < 0 ||
        (this._isSliding
          ? N.one(this._element, te, () => this.to(e))
    ...
    _addEventListeners() {
      this._config.keyboard &&
        ...
        "hover" === this._config.pause &&
          (N.on(this._element, "mouseenter.bs.carousel", () => this.pause()),
  ...
  function nt(e) {
    for (
      var t, i = He(e), n = it(e);
      n &&
      ((t = n), 0 <= ["table", "td", "th"].indexOf(Fe(t))) &&
      "static" === Ze(n).position;
    ...
    return (
      ((!n ||
        ("html" !== Fe(n) &&
          ("body" !== Fe(n) || "static" !== Ze(n).position))) &&
        (n ||
          (function (e) {
  ...
  function dt(e) {
    ...
    l &&
      ...
      (n !== _e && ((n !== ye && n !== ve) || s !== Te)) ||
        ((e = be),
        (p -=
          (h && o === d && d.visualViewport ? d.visualViewport.height : o[f]) -
          i.height),
        (p *= a ? 1 : -1)),
      (n !== ye && ((n !== _e && n !== be) || s !== Te)) ||
        ((b = ve),
        (u -=
          (h && o === d && d.visualViewport ? d.visualViewport.width : o[m]) -
          i.width),
        (u *= a ? 1 : -1)));
    var v,
      l = Object.assign({ position: r }, l && ht),
      v =
        !0 === c
          ? ((c = { x: u, y: p }),
            (v = He(t)),
  ...
  function Tt(e, t, i) {
    return t === Oe
      ? Et(
          ...
          { width: h, height: d, x: u + yt(o), y: a })
        )
      : We(t)
      ? (((s = Ue((n = t), !1, "fixed" === i)).top = s.top + n.clientTop),
  ...
  function Ot(e, t) {
    var i,
      ...
      s =
        ((i = We(h) ? h : h.contextElement || et(e.elements.popper)),
        (l = l),
        (n = d),
        (d =
          "clippingParents" === (d = f)
            ? ((s = At(tt((f = i)))),
              We(
                (o =
                  0 <= ["absolute", "fixed"].indexOf(Ze(f).position) && Be(f)
                    ? nt(f)
                    : f)
              )
                ? s.filter(function (e) {
      ...
      l = Ct({ reference: d, element: a, strategy: "absolute", placement: c }),
  ...
  var xt = {
    ...
    fn: function (e) {
      ...
      if (!d.modifiersData[i]._skip) {
        ...
        d.placement !== b &&
          ((d.modifiersData[i]._skip = !0), (d.placement = b), (d.reset = !0));
      }
    },
            ...
            return (
              (e[t] =
                ...
                (s =
                  (s = (i =
                    "function" == typeof s
                      ? s(Object.assign({}, n, { placement: i }))
                      : s)[0]) || 0),
                (i = ((i = i[1]) || 0) * t),
                0 <= [ye, ve].indexOf(o) ? { x: i, y: s } : { x: s, y: i })),
              e
            );
            var i, n, s, o;
          }, {}),
      ...
      fn: function (e) {
        ...
        T &&
          (a &&
            ...
            (r = y === Ee ? -e[g] : -C[g]),
            (a = n.elements.arrow),
            (y = m && a ? Ge(a) : { width: 0, height: 0 }),
            (h = (a = n.modifiersData["arrow#persistent"]
              ? n.modifiersData["arrow#persistent"].padding
              : { top: 0, right: 0, bottom: 0, left: 0 })[h]),
            (f = a[f]),
            (y = ot(0, C[g], y[g])),
            (h = w
              ? C[g] / 2 - u - y - h - l.mainAxis
              : _ - y - h - l.mainAxis),
            (r = w
              ? -C[g] / 2 + u + y + f + l.mainAxis
              : r + y + f + l.mainAxis),
            (f = (y = n.elements.arrow && nt(n.elements.arrow))
              ? "y" === A
                ? y.clientTop || 0
                : y.clientLeft || 0
              : 0),
  ...
  var Ft = $t(),
    Ht = $t({ defaultModifiers: [pt, It, ut, Re] }),
    Wt = $t({ defaultModifiers: [pt, It, ut, Re, Dt, xt, Nt, lt, St] });
  ...
  class ri extends H {
    constructor(e, t) {
      super(e, t),
        ...
        (this._menu =
          B.next(this._element, Gt)[0] ||
          B.prev(this._element, Gt)[0] ||
          B.findOne(Gt, this._parent)),
    ...
    static dataApiKeydownHandler(e) {
      ...
      if ((n || i) && (!t || i)) {
        e.preventDefault();
        const s = this.matches(Ut)
            ? this
            : B.prev(this, Ut)[0] ||
              B.next(this, Ut)[0] ||
              B.findOne(Ut, e.delegateTarget.parentNode),
  ...
  class Li extends H {
    ...
    show(e) {
      this._isShown ||
        this._isTransitioning ||
        N.trigger(this._element, Ti, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              N.trigger(this._element, "shown.bs.modal", { relatedTarget: e });
          },
          this._dialog,
          this._isAnimated()
        );
  ...
  class $i extends H {
    ...
    _addEventListeners() {
      N.on(this._element, "keydown.dismiss.bs.offcanvas", (e) => {
        "Escape" === e.key &&
          (this._config.keyboard ? this.hide() : N.trigger(this._element, Ni));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
              ...
              if (Object.keys(t).includes(i)) {
                ...
                for (const t of n)
                  ((e, t) => {
                    const i = e.nodeName.toLowerCase();
                    return t.includes(i)
                      ? !Hi.has(i) || Boolean(Wi.test(e.nodeValue))
                      : t
  ...
  class en extends H {
    ...
    _createTipElement(e) {
      ...
      return (
        t.setAttribute("id", e), this._isAnimated() && t.classList.add(Ki), t
      );
    }
    setContent(e) {
      (this._newContent = e),
        ...
        if ("click" === t)
          ...
          N.on(this._element, e, this._config.selector, (e) => {
            ...
            N.on(this._element, i, this._config.selector, (e) => {
              const t = this._initializeOnDelegatedTarget(e);
              (t._activeTrigger["focusout" === e.type ? Ui : Yi] =
  ...
  class Tn extends H {
    ...
    show() {
      ...
      this._elemIsActive(i) ||
        ((t = (e = this._getActiveElem())
          ? N.trigger(e, "hide.bs.tab", { relatedTarget: i })
          : null),
        N.trigger(i, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
    ...
    _keydown(t) {
      if ([un, fn, pn, mn, gn, _n].includes(t.key)) {
        ...
        var i,
          n = this._getChildren().filter((e) => !h(e));
        let e;
        (e = [gn, _n].includes(t.key)
          ? n[t.key === gn ? 0 : n.length - 1]
          : ((i = [fn, mn].includes(t.key)), b(n, t.target, i, !0))),
          e &&
            (e.focus({ preventScroll: !0 }), Tn.getOrCreateInstance(e).show());
      }
    }
    _getChildren() {
  ...
  const Cn = "show",
    ...
    kn = { animation: !0, autohide: !0, delay: 5e3 };
  class Ln extends H {
    constructor(e, t) {
      super(e, t),
        (this._timeout = null),
